...
class CInspectAdminViewHideDlg4 : public CDialog, public IInspectAdminViewHideDlg
{
private:

	CRect	m_ScreenRect;
	static CInspectAdminViewHideDlg4* m_pInstance;

public:
	static	CInspectAdminViewHideDlg4* GetInstance(BOOL bShowFlag = FALSE);
	void	DeleteInstance();
...
protected:
	...
	//{{AFX_MSG(CInspectAdminViewHideDlg4)
	...
	//{{AFX_VIRTUAL(CInspectAdminViewHideDlg4)
...
public:
	...
	CInspectAdminViewHideDlg4(CWnd* pParent = NULL);   // standard constructor
	...
	// Dialog Data
	//{{AFX_DATA(CInspectAdminViewHideDlg4)
	enum { IDD = IDD_INSPECT_ADMIN_VIEW_HIDE_DLG4 };
