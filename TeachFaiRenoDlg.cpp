...
IMPLEMENT_DYNAMIC(CTeachFaiRenoDlg, CDialog)

CTeachFaiRenoDlg::CTeachFaiRenoDlg(CWnd* pParent /*=nullptr*/)
	: CDialog(IDD_TEACH_FAI_RENO_DLG, pParent)
{
...
void CTeachFaiRenoDlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CTeachFaiRenoDlg, CDialog)
	ON_BN_CLICKED(IDOK, &CTeachFaiRenoDlg::OnBnClickedOk)
	ON_BN_CLICKED(IDCANCEL, &CTeachFaiRenoDlg::OnBnClickedCancel)
END_MESSAGE_MAP()



// CTeachFaiRenoDlg 메시지 처리기

BOOL CTeachFaiRenoDlg::PreTranslateMessage(MSG* pMsg)
{
...
BOOL CTeachFaiRenoDlg::OnInitDialog()
{
...
void CTeachFaiRenoDlg::OnBnClickedOk()
{
...
void CTeachFaiRenoDlg::OnBnClickedCancel()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	CDialog::OnCancel();
}
