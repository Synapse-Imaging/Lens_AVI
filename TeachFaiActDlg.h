...
class CTeachFaiActDlg : public CDialog
{
	DECLARE_DYNAMIC(CTeachFaiActDlg)

public:
	CTeachFaiActDlg(CWnd* pParent = nullptr);   // 표준 생성자입니다.
	virtual ~CTeachFaiActDlg();
	...
	enum { IDD = IDD_TEACH_FAI_ACT_DLG };
#endif
