...
class CTeachFaiBoiDlg : public CDialog
{
	DECLARE_DYNAMIC(CTeachFaiBoiDlg)

public:
	CTeachFaiBoiDlg(CWnd* pParent = nullptr);   // 표준 생성자입니다.
	virtual ~CTeachFaiBoiDlg();
	...
	enum { IDD = IDD_TEACH_FAI_BOI_DLG };
#endif
