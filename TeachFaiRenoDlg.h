...
class CTeachFaiRenoDlg : public CDialog
{
	DECLARE_DYNAMIC(CTeachFaiRenoDlg)

public:
	CTeachFaiRenoDlg(CWnd* pParent = nullptr);   // 표준 생성자입니다.
	virtual ~CTeachFaiRenoDlg() = default;
	CButtonCS m_bnOK;
	CButtonCS m_bnCancel;

	// 대화 상자 데이터입니다.
#ifdef AFX_DESIGN_TIME
	enum { IDD = IDD_TEACH_FAI_RENO_DLG };
#endif
