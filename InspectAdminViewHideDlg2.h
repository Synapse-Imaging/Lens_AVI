...
class CInspectAdminViewHideDlg2 : public CDialog, public IInspectAdminViewHideDlg
{
private:

	CRect	m_ScreenRect;
	static CInspectAdminViewHideDlg2* m_pInstance;

public:
	static	CInspectAdminViewHideDlg2* GetInstance(BOOL bShowFlag = FALSE);
	void	DeleteInstance();
...
protected:
	...
	//{{AFX_MSG(CInspectAdminViewHideDlg2)
	...
	//{{AFX_VIRTUAL(CInspectAdminViewHideDlg2)
...
public:
	...
	//////////////////////////////////////////////////////////////////////////////////////////
	CInspectAdminViewHideDlg2(CWnd* pParent = NULL);   // standard constructor
	...
	// Dialog Data
	//{{AFX_DATA(CInspectAdminViewHideDlg2)
	enum { IDD = IDD_INSPECT_ADMIN_VIEW_HIDE_DLG2 };
