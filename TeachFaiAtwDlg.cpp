...
IMPLEMENT_DYNAMIC(CTeachFaiAtwDlg, CDialog)

CTeachFaiAtwDlg::CTeachFaiAtwDlg(CWnd* pParent /*=nullptr*/)
	: CDialog(IDD_TEACH_FAI_ATW_DLG, pParent)
{
...
void CTeachFaiAtwDlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CTeachFaiAtwDlg, CDialog)
	ON_BN_CLICKED(IDOK, &CTeachFaiAtwDlg::OnBnClickedOk)
	ON_BN_CLICKED(IDCANCEL, &CTeachFaiAtwDlg::OnBnClickedCancel)
END_MESSAGE_MAP()



// CTeachFaiAtwDlg 메시지 처리기

BOOL CTeachFaiAtwDlg::PreTranslateMessage(MSG* pMsg)
{
...
BOOL CTeachFaiAtwDlg::OnInitDialog()
{
...
void CTeachFaiAtwDlg::OnBnClickedOk()
{
...
void CTeachFaiAtwDlg::OnBnClickedCancel()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	CDialog::OnCancel();
}
