...
class CTeachFaiAtwDlg : public CDialog
{
	DECLARE_DYNAMIC(CTeachFaiAtwDlg)

public:
	CTeachFaiAtwDlg(CWnd* pParent = nullptr);   // 표준 생성자입니다.
	virtual ~CTeachFaiAtwDlg() = default;
	CButtonCS m_bnOK;
	CButtonCS m_bnCancel;

	// 대화 상자 데이터입니다.
#ifdef AFX_DESIGN_TIME
	enum { IDD = IDD_TEACH_FAI_ATW_DLG };
#endif
