...
class CInspectAdminViewHideDlg3 : public CDialog, public IInspectAdminViewHideDlg
{
private:

	CRect	m_ScreenRect;
	static CInspectAdminViewHideDlg3* m_pInstance;

public:
	static	CInspectAdminViewHideDlg3* GetInstance(BOOL bShowFlag = FALSE);
	void	DeleteInstance();
...
protected:
	...
	//{{AFX_MSG(CInspectAdminViewHideDlg3)
	...
	//{{AFX_VIRTUAL(CInspectAdminViewHideDlg3)
...
public:
	...
	//////////////////////////////////////////////////////////////////////////////////////////
	CInspectAdminViewHideDlg3(CWnd* pParent = NULL);   // standard constructor
	...
	// Dialog Data
	//{{AFX_DATA(CInspectAdminViewHideDlg3)
	enum { IDD = IDD_INSPECT_ADMIN_VIEW_HIDE_DLG3 };
