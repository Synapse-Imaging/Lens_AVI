...
class CInspectViewOverayImageDlg3 : public CDialog
{
	private:
	void	SetPosition(int left, int top, int right, int bottom) { m_ScreenRect = CRect(left, top, right, bottom); }
	CRect	m_ScreenRect;
	static CInspectViewOverayImageDlg3	*m_pInstance;

public:
	static	CInspectViewOverayImageDlg3* GetInstance(BOOL bShowFlag=FALSE);
	void	DeleteInstance();
...
// Construction
public:
	CInspectViewOverayImageDlg3(CWnd* pParent = NULL);   // standard constructor
...
// Dialog Data
	//{{AFX_DATA(CInspectViewOverayImageDlg3)
	enum { IDD = IDD_INSPECT_VIEW_OVERAY_IMAGE3_DLG };
...
// Overrides
	...
	//{{AFX_VIRTUAL(CInspectViewOverayImageDlg3)
	protected:
...
protected:
	...
	//{{AFX_MSG(CInspectViewOverayImageDlg3)
