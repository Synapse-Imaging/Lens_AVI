...
void KRIOSFAIInspector::SetAlgorithm(Algorithm* pAlgorithm)
{
 ...
 */
void KRIOSFAIInspector::Inspect(BOOL bIsAutoInsp, int iInspectionBufferIdx, int iFAIParamNo)
{
    // TODO : KRIOS 검사 로직 구현
    ...
    {
        OutputDebugString(_T("[KRIOSFAIInspector] Algorithm instance or FAI Measure Struct is null. FAI Inspection aborted.\n"));
        return;
    }
