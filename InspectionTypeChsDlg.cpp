// InspectionTypeChsDlg.cpp : 구현 파일입니다.
//
...
IMPLEMENT_DYNAMIC(CInspectionTypeChsDlg, CDialog)

CInspectionTypeChsDlg::CInspectionTypeChsDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CInspectionTypeChsDlg::IDD, pParent)
{
...
CInspectionTypeChsDlg::~CInspectionTypeChsDlg()
{
}

void CInspectionTypeChsDlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CInspectionTypeChsDlg, CDialog)
	ON_BN_CLICKED(IDOK, &CInspectionTypeChsDlg::OnBnClickedOk)
	ON_BN_CLICKED(IDCANCEL, &CInspectionTypeChsDlg::OnBnClickedCancel)
	ON_BN_CLICKED(ID_BUTTON_GEN_LINE, &CInspectionTypeChsDlg::OnBnClickedButtonGenLine)
END_MESSAGE_MAP()


// CInspectionTypeChsDlg 메시지 처리기입니다.


BOOL CInspectionTypeChsDlg::PreTranslateMessage(MSG* pMsg)
{
...
void CInspectionTypeChsDlg::OnBnClickedOk()
{
	UpdateData();
...
void CInspectionTypeChsDlg::OnBnClickedCancel()
{
	CDialog::OnCancel();
}


BOOL CInspectionTypeChsDlg::OnInitDialog()
{
...
void CInspectionTypeChsDlg::OnBnClickedButtonGenLine()
{
