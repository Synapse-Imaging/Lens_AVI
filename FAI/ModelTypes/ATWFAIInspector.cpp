...
void ATWFAIInspector::SetAlgorithm(Algorithm* pAlgorithm)
{
 ...
 */
void ATWFAIInspector::Inspect(BOOL bIsAutoInsp, int iInspectionBufferIdx, int iFAIParamNo)
{
    // TODO : ATW 검사 로직 구현
    ...
    {
        OutputDebugString(_T("[ATWFAIInspector] Algorithm instance or FAI Measure Struct is null. FAI Inspection aborted.\n"));
        return;
    }
