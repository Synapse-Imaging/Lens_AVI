// InspectionTypeChsWZDlg.cpp : 구현 파일입니다.
//
...
// CInspectionTypeChsDlg 대화 상자입니다.

IMPLEMENT_DYNAMIC(CInspectionTypeChsWZDlg, CDialog)

CInspectionTypeChsWZDlg::CInspectionTypeChsWZDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CInspectionTypeChsWZDlg::IDD, pParent)
{
...
CInspectionTypeChsWZDlg::~CInspectionTypeChsWZDlg()
{
}

void CInspectionTypeChsWZDlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CInspectionTypeChsWZDlg, CDialog)
	ON_BN_CLICKED(IDOK, &CInspectionTypeChsWZDlg::OnBnClickedOk)
	ON_BN_CLICKED(IDCANCEL, &CInspectionTypeChsWZDlg::OnBnClickedCancel)
	ON_BN_CLICKED(ID_BUTTON_GEN_LINE, &CInspectionTypeChsWZDlg::OnBnClickedButtonGenLine)
END_MESSAGE_MAP()


// CInspectionTypeChsWZDlg 메시지 처리기입니다.


BOOL CInspectionTypeChsWZDlg::PreTranslateMessage(MSG* pMsg)
{
...
void CInspectionTypeChsWZDlg::OnBnClickedOk()
{
	UpdateData();
...
void CInspectionTypeChsWZDlg::OnBnClickedCancel()
{
	CDialog::OnCancel();
}


BOOL CInspectionTypeChsWZDlg::OnInitDialog()
{
...
void CInspectionTypeChsWZDlg::OnBnClickedButtonGenLine()
{
