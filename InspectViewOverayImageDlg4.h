...
class CInspectViewOverayImageDlg4 : public CDialog
{
	private:
	void	SetPosition(int left, int top, int right, int bottom) { m_ScreenRect = CRect(left, top, right, bottom); }
	CRect	m_ScreenRect;
	static CInspectViewOverayImageDlg4	*m_pInstance;

public:
	static	CInspectViewOverayImageDlg4* GetInstance(BOOL bShowFlag=FALSE);
	void	DeleteInstance();
...
// Construction
public:
	CInspectViewOverayImageDlg4(CWnd* pParent = NULL);   // standard constructor
...
// Dialog Data
	//{{AFX_DATA(CInspectViewOverayImageDlg4)
	enum { IDD = IDD_INSPECT_VIEW_OVERAY_IMAGE4_DLG };
...
// Overrides
	...
	//{{AFX_VIRTUAL(CInspectViewOverayImageDlg4)
	protected:
...
protected:
	...
	//{{AFX_MSG(CInspectViewOverayImageDlg4)
