...
class CInspectionTypeChsDlg : public CDialog
{
	DECLARE_DYNAMIC(CInspectionTypeChsDlg)

public:
	CInspectionTypeChsDlg(CWnd* pParent = NULL);   // 표준 생성자입니다.
	virtual ~CInspectionTypeChsDlg();

// 대화 상자 데이터입니다.
	enum { IDD = IDD_COSMETIC_INSPECTION_TYPE_CHS_KS_DLG };
